  ...
  if (result.first != super::end ())
    {
      if (result.second)
  	  ...
  	  if(result.first->GetRoutingCost()%10==0)	
      	...
      	super::modify (result.first,
                      ...
                      result.first->GetRoutingCost ()%10+1	//#faces
				     +(result.first->GetRoutingCost () - result.first->GetRoutingCost ()%10)*100	//previous routes (two-digit metric)	
