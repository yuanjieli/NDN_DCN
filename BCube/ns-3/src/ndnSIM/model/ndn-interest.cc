...
Interest::Interest ()
  ...
  , m_intra_sharing (120)	//larger than 100, normal nack
{
}
...
Interest::Interest (const Interest &interest)
  ...
  , m_intra_sharing				(interest.m_intra_sharing)
{
}
...
void
Interest::SetIntraSharing (uint8_t rhs)
{
	m_intra_sharing = rhs;
}

uint8_t
Interest::GetIntraSharing () const
{
	return m_intra_sharing;
}
