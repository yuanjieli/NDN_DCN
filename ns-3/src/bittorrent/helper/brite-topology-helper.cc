...
NodeContainer BriteTopologyHelper::AddNodeToLastTopology (Ptr<Node> parent, std::string deviceType, std::string upstreamBandwidth, std::string downstreamBandwidth, std::string delay, bool isRouterNode, bool isBorderRouterNode, int32_t AS, bool isTrackerNode)
{
...
bool BriteTopologyHelper::EstablishNetworkOnLastTopology ()
{
  ...
  ipv4Helper.SetBase ("10.1.0.0", "255.255.255.255");
  ipv4Helper.Assign (trackerInterfaces);
  ipv4Helper.SetBase ("10.2.0.0", "255.255.255.255");
  ipv4Helper.Assign (ptpInterfaces);
  ipv4Helper.SetBase ("10.100.0.0", "255.255.0.0");
  ipv4Helper.Assign (csmaInterfaces);
  Ipv4AddressHelper helper2;
  helper2.SetBase ("192.168.0.0", "255.255.255.0");
  helper2.Assign (csmaTapInterfaces);
