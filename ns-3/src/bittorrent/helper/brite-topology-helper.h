...
public:
   ...
   *
   */
  NodeContainer AddNodeToLastTopology (Ptr<Node> parent, std::string deviceType, std::string upstreamBandwidth, std::string downstreamBandwidth, std::string delay, bool isRouterNode, bool isBorderRouterNode = false, int32_t AS = 0, bool isTrackerNode = false);
